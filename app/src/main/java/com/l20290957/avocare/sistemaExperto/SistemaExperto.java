package com.l20290957.avocare.sistemaExperto;
...
public class SistemaExperto extends AppCompatActivity {
    private CheckBox checkBoxAreaFruto, checkBoxAreaHoja, checkBoxAreaTallo, checkBoxAreaFlor, checkBoxEtapaTodas, checkBoxEtapaFlujoVegetativo, checkBoxEtapaDesarrolloFloral;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sistemaexperto);
        ...
        checkBoxEtapaTodas = findViewById(R.id.checkbox_etapatodas);
        checkBoxEtapaFlujoVegetativo = findViewById(R.id.checkbox_etapa_flujo_vegetativo);
        checkBoxEtapaDesarrolloFloral = findViewById(R.id.checkbox_etapa_desarrollo_floral);
        ...
        checkBoxEtapaTodas.setOnCheckedChangeListener((buttonView, isChecked) -> updateCheckBoxVisibility());
        checkBoxEtapaDesarrolloFloral.setOnCheckedChangeListener((buttonView, isChecked) -> updateCheckBoxVisibility());
    ...
    private void updateCheckBoxVisibility() {
        ...
        if (checkBoxAreaFruto.isChecked() && checkBoxEtapaTodas.isChecked()) {
        ...
        if (checkBoxAreaHoja.isChecked() && checkBoxEtapaTodas.isChecked()) {
        ...
        if (checkBoxAreaTallo.isChecked() && checkBoxEtapaTodas.isChecked()) {
        ...
        if (checkBoxAreaFlor.isChecked() && checkBoxEtapaTodas.isChecked()) {
